              ...
              <div key={index} className="space-y-2">
                <div className="flex items-stretch gap-2 w-full">
                  ...
                  <input
                    ...
                    placeholder="HCP"
                    className={`flex-shrink-0 w-16 rounded-xl border-2 px-2 py-3 text-base leading-normal min-h-[48px] shadow-sm focus:outline-none focus:ring-2 focus:ring-[#2d5016]/50 ${
